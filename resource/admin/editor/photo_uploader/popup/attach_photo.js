	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/admin/cm/pop/ccMan.do',  //샘플 URL입니다.
 	        sCallback : '/admin/cm/pop/ccCallBackMan.do',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소, 서버단에서 호출되는 것이기 때무에 ContextPath를 빼줘야 한다.ㄴ
